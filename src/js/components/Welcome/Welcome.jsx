  ...
  return (
    <div className="card">
      ...
      <div className="card-child">
        ...
        <p>Feel free to call me <strong>Evo</strong> for short. I am a San Diego native who enjoys coding! I have been in tech for about 5 years hands on and 2 1/2 years professionally, along with
