  ...
  return (
    <div id="about" className="section-header about">
      ...
      <p className="about-me">
        ...
        web applications, servers, creating databases, and whatever else I can create with Javascript. My education
        came from Origin Code Academy, and also have associates degrees for business and technologies, business and
        economics, and business administration. I have been busy the majority of my life learning different trades
        and skills, but with web devolopment I find myself really seeing a future I look forward too. I picked up and
        learned many lessons along the way of my journey, and I feel I can be an asset to any company or group.
      </p>
    </div>
  )
}
