...
export const projects = [
  ...
  },
  {
    ...
    href: 'https://owa-origin-weather-app.herokuapp.com/',
  ...
  },
  {
    ...
    description: 'Origin Code Academy mobile application for students to checkin and get information about progress in the program. In this project my group and I are using React Native, Redux, MongoDB, and loopback to create a way for students to checkin to class replacing a bar code scanner. The school has shut down and is no longer in the google play store.'
  },
  {
    id: 5,
    title: 'vstda',
